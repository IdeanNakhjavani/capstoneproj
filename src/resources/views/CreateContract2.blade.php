...
<head>
 ...
 <!-- CSRF Token -->
    <title>New Contract - Interior Energy & Air</title>
...
<body>
    ...
    <div class="row">
        @foreach ($tbl_contracts as $tbl_contracts)
            <form action="{{ url('insertcontract2/' . $tbl_contracts->ContractID) }}" method="post" class="form-group"
                                    ...
                                    <div class="form-group row">
                                        <div class="form-group col-xs-5">
                                            ...
                                            <input type="text" name="address" id="address" class="form-control"
                                                placeholder="Address" value="{{ $tbl_contracts->BuildingAddress }}">
                                        </div>
                                        &nbsp;&nbsp;
                                        <div class="form-group col-xs-5">
                                            <label for="CompanyName">CompanyName</label>
                                            <input type="text" name="CompanyName" id="CompanyName"
                                                class="form-control" placeholder="CompanyName"
                                                value="{{ $tbl_contracts->CompanyName }}">
                                        </div>
                                        &nbsp;&nbsp;
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="form-group col-xs-5">
                                            ...
                                            <input type="text" name="BuildingDesc" id="BuildingDesc"
                                                class="form-control" placeholder="BuildingDesc"
                                                value="{{ $tbl_contracts->BuildingDesc }}">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="form-group col-xs-3">
