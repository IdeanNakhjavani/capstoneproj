...
<head>
 ...
 <!-- CSRF Token -->
    <title>Equipment List - Interior Energy & Air</title>
   ...
   <div class=" jumbotron row">
            <div class="col-md-12">
                ...
                <div style="text-align:right">
                    <form action="{{url('/createequipment')}}">
                        
                        <input type="submit" class="btn btn-success" value="+ New Equipment" />
                    </form>
                </div>
                <br>
                <table id="equipmentlist" class="table table-hover table-sm">
                    <thead>
                        <tr>
                            <th>Equipment ID</th>
                            <th>UnitID</th>
                    ...
                    <tbody>
                        @foreach ($tbl_equipment as $tbl_equipment)
                            <tr class="table-tr" data-url= "{{url('/viewequipment/'.$tbl_equipment->EquipmentID)}}">
                                <td>{{ $tbl_equipment->EquipmentID }}</a></td>
                                <td>{{ $tbl_equipment->UnitID }} </td>
                                <td>{{ $tbl_equipment->Model }}</td>
                                <td>{{ $tbl_equipment->BuildingDesc }}</td>
                            </tr>
                        @endforeach
                    </tbody>
                </table>
